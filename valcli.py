...
def cmd_storage_list():
    ...
    # Read dfs_engine from cluster.json
    ...
    if dfs_engine == "linstor":
        ...
        res_nodes = subprocess.run("podman exec systemd-aether linstor node list", shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
        ...
        res_vols = subprocess.run("podman exec systemd-aether linstor volume list", shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)

...
**Gatoway** is the host-level L2 networking coordinator and bridge synchronization daemon for the hypervisor hosts. It is the direct equivalent of Nutanix **Gato** (which manages Open vSwitch (OVS) bridges and VLAN interfaces for virtual machines).

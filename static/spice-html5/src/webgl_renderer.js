...
class WebGLContextEmulator {
    constructor(canvas) {
        ...
        const vsSource = `
            ...
            void main() {
                ...
                v_texCoord = u_tex_rect.xy + zeroToOne * u_tex_rect.zw;
            }
        `;
        ...
        this.texRectUniformLocation = gl.getUniformLocation(this.program, "u_tex_rect");
    ...
    fillRect(x, y, w, h) {
        ...
        gl.uniform4f(this.texRectUniformLocation, 0.0, 0.0, 1.0, 1.0);
    ...
    drawImage(img, ...args) {
        ...
        let sx = 0, sy = 0, sw = img.width || img.naturalWidth || 0, sh = img.height || img.naturalHeight || 0;
        ...
        gl.uniform2f(this.resolutionUniformLocation, this.canvas.width, this.canvas.height);
        gl.uniform4f(this.rectUniformLocation, dx, dy, dw, dh);
        gl.uniform4f(this.texRectUniformLocation, tx, ty, tw, th);

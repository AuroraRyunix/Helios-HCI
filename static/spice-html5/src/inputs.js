...
{
    if (this.sc && this.sc.mouse_mode === Constants.SPICE_MOUSE_MODE_CLIENT && document.pointerLockElement)
    {
...
function handle_mousedown(e)
{
    ...
    else if (this.sc && this.sc.mouse_mode === Constants.SPICE_MOUSE_MODE_CLIENT)
    {

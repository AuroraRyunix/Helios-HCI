    ...
    for i in range(15):
        ...
        if rc == 0:
            ...
            if (rc2 == 0 and rc3 == 0 and rc4 == 0 and rc5 == 0 and rc6 == 0 and 
                rc7 == 0 and rc8 == 0 and rc9 == 0 and rc10 == 0 and rc11 == 0 and rc12 == 0 and rc13 == 0 and
                    ...
                    if old_iso != iso:
                        ...
                        for slot_idx in range(max_slots):
                            ...
                            if new_spec == "__empty__":
                                ...
                                rc_q, _, _ = run_remote_spark(host_ip, qmp_cmd)
                                if rc_q != 0:
                                    run_remote_spark(host_ip, f"virsh -c qemu:///system change-media {name} {dev_name} --eject --force")
                            else:
                                # Mount/Swap this slot
                                ...
                                rc_q, stdout_q, _ = run_remote_spark(host_ip, qmp_cmd)
                                if rc_q != 0 or "error" in stdout_q:
                                    ...
                                    if rc_c != 0:
                                        run_remote_spark(host_ip, f"virsh -c qemu:///system change-media {name} {dev_name} {iso_path} --insert --force")

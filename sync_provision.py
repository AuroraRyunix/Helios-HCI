...
if "HYLIA_B64 = " not in content:
    print("Injecting HYLIA_B64 declaration...")
    content = content.replace('DARUK_B64 = "', 'HYLIA_B64 = ""\n\nDARUK_B64 = "', 1)
...
if "Deploy Hylia Daemon" not in content:
    print("Injecting Hylia deployment code...")
    target_pattern = 'node.execute("systemctl enable catalyst")'
    replacement = (

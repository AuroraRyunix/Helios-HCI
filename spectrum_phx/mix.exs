defmodule SpectrumPhx.MixProject do
  use Mix.Project
  ...
  defp aliases do
    [
      ...
      "assets.build": ["compile", "tailwind spectrum_phx", "esbuild spectrum_phx"],
      "assets.deploy": [
        "tailwind spectrum_phx --minify",
        "esbuild spectrum_phx --minify",
        "phx.digest"
      ],

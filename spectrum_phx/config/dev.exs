...
config :spectrum_phx, SpectrumPhxWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "1dtxDGnYaz9Wfp0i1CrlGe77bnZWNBFlF/uP60VB24KuxyY7etobNYDh599WWyep",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:spectrum_phx, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:spectrum_phx, ~w(--watch)]}
  ]
...
config :spectrum_phx, dev_routes: true

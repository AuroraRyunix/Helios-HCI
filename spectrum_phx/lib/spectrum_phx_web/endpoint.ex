defmodule SpectrumPhxWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :spectrum_phx
  ...
  @session_options [
    store: :cookie,
    key: "_spectrum_phx_key",
    signing_salt: "hjpQziPq",
    same_site: "Lax"
  ]
  ...
  plug Plug.Static,
    ...
    only: SpectrumPhxWeb.static_paths(),
